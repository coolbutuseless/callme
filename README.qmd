...
This simple implentation is slightly faster than the built-in version in R.  It's
probably faster because it doesn't do *anything* to check the sanity of the inputs.
