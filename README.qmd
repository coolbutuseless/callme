...
Te relative performance of the following implementations of `sqrt` will be
very very dependent upon:
...
The following benchmark numbers are for an Apple M2 CPU.  Your results will 
vary.
